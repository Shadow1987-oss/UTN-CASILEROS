        ...
        <div class="card">
            ...
            <div class="card">
                ...
                <div class="grid grid-3" style="margin-top: 16px;">
                    <div class="stat">
                        <h3>Disponibles</h3>
                        <p>{{ $available_lockers }}</p>
                    </div>
                    <div class="stat">
                        <h3>Ocupados</h3>
                        <p>{{ $occupied_lockers }}</p>
                    </div>
                    <div class="stat">
                        <h3>Dañados</h3>
                        <p>{{ $damaged_lockers }}</p>
            ...
            <div style="margin-top: 24px;">
                ...
                <div
                    style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; border-radius: 12px; background: #000; box-shadow: var(--shadow);">
                    <iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border-radius: 12px;"
                        src="https://www.youtube.com/embed/ScMzIvxBSi4" title="Video Institucional UTNAY" frameborder="0"
...
@section('scripts')
    <script>
        ...
        function initMap() {
            ...
            var utn = {
                lat: 21.424081270651673,
                lng: -104.89837987466123
            };
