            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <div class="social-links" style="justify-content: center;">
                        <a href="https://www.facebook.com/UTNAY" target="_blank" rel="noopener noreferrer"
                            title="Facebook">
                        ...
                        <a href="https://x.com/utnay_comer" target="_blank" rel="noopener noreferrer"
                            title="Twitter">
                            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="https://www.instagram.com/ut.nayarit/" target="_blank" rel="noopener noreferrer"
                            title="Instagram">
                            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="https://www.linkedin.com/company/utnay" target="_blank" rel="noopener noreferrer"
                            title="LinkedIn">
                            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                                <path
