    ...
    <div class="wrapper">
        ...
        <header>
            <div class="content">
                ...
                <nav>
                    @section('menu')
                    <a href="{{ route('dashboard') }}" class="{{ request()->routeIs('dashboard') ? 'active' : '' }}">Tablero</a>
                    <a href="{{ route('students.index') }}" class="{{ request()->routeIs('students.*') ? 'active' : '' }}">Estudiantes</a>
                    <a href="{{ route('lockers.index') }}" class="{{ request()->routeIs('lockers.*') ? 'active' : '' }}">Casilleros</a>
                    <a href="{{ route('periods.index') }}" class="{{ request()->routeIs('periods.*') ? 'active' : '' }}">Períodos</a>
                    <a href="{{ route('assignments.index') }}" class="{{ request()->routeIs('assignments.*') ? 'active' : '' }}">Asignaciones</a>
                    @show
                </nav>
            </div>
        </header>
        ...
        <footer id="pie-pagina">
            <div class="footer-content">
                <div class="footer-section">
                    ...
                    <p>Sistema de asignación y control de casilleros para estudiantes de la Universidad Tecnológica de Nayarit en Xalisco.</p>
                </div>
                <div class="footer-section">
