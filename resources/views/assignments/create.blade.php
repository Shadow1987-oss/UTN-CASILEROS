    ...
    <form class="form" method="POST" action="{{ route('assignments.store') }}" id="assignment-form">
        ...
        <div class="field">
            ...
            <select id="matricula" name="matricula" class="input" required>
                ...
                <option value="{{ $student->matricula }}" {{ old('matricula') == $student->matricula ? 'selected' : '' }}>
        ...
        <div class="field">
            ...
            <select id="idcasillero" name="idcasillero" class="input" required>
                ...
                <option value="{{ $locker->idcasillero }}" {{ old('idcasillero') == $locker->idcasillero ? 'selected' : '' }}>
        ...
        <div class="field">
            ...
            <select id="idPeriodo" name="idPeriodo" class="input" required>
                ...
                <option value="{{ $period->idperiodo }}" {{ old('idPeriodo') == $period->idperiodo ? 'selected' : '' }}>
        ...
        @include('partials.form-field', ['label' => 'Notas', 'name' => 'notes', 'type' => 'textarea', 'value' => old('notes')])
